...
describe APIv2::Trades do
  ...
  let(:ask) { create(:order_ask, currency: 'btcusd', price: '12.326'.to_d, volume: '123.123456789', member: member) }
  let(:bid) { create(:order_bid, currency: 'btcusd', price: '12.326'.to_d, volume: '123.123456789', member: member) }
